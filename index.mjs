...
const playerConfig = [
  ...
  {x: 0,                 y: gameHeight - 1,   velocity:-1,  horizontal:false,   brains: [new GamePadBrain(0, antiXbox), new KeyBrain(antiArrows), new SwipeBrain(30, ['down', 'up', 'right', 'left'])],   color:'#8ae232'},
