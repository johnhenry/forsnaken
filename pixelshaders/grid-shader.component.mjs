...
export default class extends HTMLElement {
  ...
  renderHandler(event){
    ...
    const transformed = new ImageData(addBorder(data, width, this.cellwidth, this.cellheight), width);
    this.parentElement.dispatchEvent(new CustomEvent(type, {detail:transformed, bubbles}));
  }
}